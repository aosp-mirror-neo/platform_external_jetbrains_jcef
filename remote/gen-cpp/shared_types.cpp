...
int _kCefValueTypeValues[] = {
  CefValueType::BOOL,
  CefValueType::INT,
  CefValueType::DOUBLE,
  CefValueType::STRING,
  CefValueType::BYTE_BUFFER,
  CefValueType::MAP,
  CefValueType::LIST,
  CefValueType::NONE
};
const char* _kCefValueTypeNames[] = {
  "BOOL",
  "INT",
  "DOUBLE",
  "STRING",
...
const std::map<int, const char*> _CefValueType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(8, _kCefValueTypeValues, _kCefValueTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const CefValueType::type& val) {
  std::map<int, const char*>::const_iterator it = _CefValueType_VALUES_TO_NAMES.find(val);
  if (it != _CefValueType_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
void RObject::__set_uid(const int32_t val) {
  this->uid = val;
}
...
void RObject::__set_info(const std::map<std::string, std::string> & val) {
  this->info = val;
__isset.info = true;
}
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i4 = 0; _i4 < _size0; ++_i4)
            {
              ...
              std::string& _val6 = this->info[_key5];
...
uint32_t RObject::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.info) {
    xfer += oprot->writeFieldBegin("info", ::apache::thrift::protocol::T_MAP, 4);
    {
      xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_STRING, ::apache::thrift::protocol::T_STRING, static_cast<uint32_t>(this->info.size()));
      std::map<std::string, std::string> ::const_iterator _iter7;
      for (_iter7 = this->info.begin(); _iter7 != this->info.end(); ++_iter7)
      {
...
CefValue::~CefValue() noexcept {
}


void CefValue::__set_type(const CefValueType::type val) {
  this->type = val;
}

void CefValue::__set_intVal(const int64_t val) {
  this->intVal = val;
__isset.intVal = true;
}

void CefValue::__set_doubleVal(const double val) {
  this->doubleVal = val;
__isset.doubleVal = true;
}

void CefValue::__set_strVal(const std::string& val) {
  this->strVal = val;
__isset.strVal = true;
}

void CefValue::__set_binVal(const std::string& val) {
  this->binVal = val;
__isset.binVal = true;
}

void CefValue::__set_mapVal(const std::map<std::string, CefValue> & val) {
  this->mapVal = val;
__isset.mapVal = true;
}

void CefValue::__set_listVal(const std::vector<CefValue> & val) {
  this->listVal = val;
...
uint32_t CefValue::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I64) {
          xfer += iprot->readI64(this->intVal);
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->strVal);
      ...
      case 5:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readBinary(this->binVal);
          this->__isset.binVal = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t CefValue::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("CefValue");
  ...
  if (this->__isset.intVal) {
    xfer += oprot->writeFieldBegin("intVal", ::apache::thrift::protocol::T_I64, 2);
    xfer += oprot->writeI64(this->intVal);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.doubleVal) {
    xfer += oprot->writeFieldBegin("doubleVal", ::apache::thrift::protocol::T_DOUBLE, 3);
    xfer += oprot->writeDouble(this->doubleVal);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.strVal) {
    xfer += oprot->writeFieldBegin("strVal", ::apache::thrift::protocol::T_STRING, 4);
    xfer += oprot->writeString(this->strVal);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.binVal) {
    xfer += oprot->writeFieldBegin("binVal", ::apache::thrift::protocol::T_STRING, 5);
    xfer += oprot->writeBinary(this->binVal);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.mapVal) {
...
void swap(CefValue &a, CefValue &b) {
  using ::std::swap;
  swap(a.type, b.type);
  swap(a.intVal, b.intVal);
  swap(a.doubleVal, b.doubleVal);
  swap(a.strVal, b.strVal);
  swap(a.binVal, b.binVal);
  swap(a.mapVal, b.mapVal);
  swap(a.listVal, b.listVal);
  swap(a.__isset, b.__isset);
}
...
void CefValue::printTo(std::ostream& out) const {
  ...
  out << ", " << "strVal="; (__isset.strVal ? (out << to_string(strVal)) : (out << "<null>"));
  out << ", " << "binVal="; (__isset.binVal ? (out << to_string(binVal)) : (out << "<null>"));
  out << ", " << "mapVal="; (__isset.mapVal ? (out << to_string(mapVal)) : (out << "<null>"));
  out << ", " << "listVal="; (__isset.listVal ? (out << to_string(listVal)) : (out << "<null>"));
  out << ")";
}
