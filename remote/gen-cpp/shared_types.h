...
class CefValue : public virtual ::apache::thrift::TBase {
 public:
  ...
  CefValue() noexcept
           : type(static_cast<CefValueType::type>(7)),
             intVal(0),
             doubleVal(0),
             strVal(),
             binVal() {
  ...
  bool operator == (const CefValue & rhs) const
  {
    ...
    if (__isset.doubleVal != rhs.__isset.doubleVal)
      ...
      return false;
    if (__isset.strVal != rhs.__isset.strVal)
      return false;
    else if (__isset.strVal && !(strVal == rhs.strVal))
      return false;
    if (__isset.binVal != rhs.__isset.binVal)
      return false;
    else if (__isset.binVal && !(binVal == rhs.binVal))
      return false;
    if (__isset.mapVal != rhs.__isset.mapVal)
      return false;
    else if (__isset.mapVal && !(mapVal == rhs.mapVal))
      return false;
    if (__isset.listVal != rhs.__isset.listVal)
      return false;
    else if (__isset.listVal && !(listVal == rhs.listVal))
      return false;
    return true;
  }
  bool operator != (const CefValue &rhs) const {
